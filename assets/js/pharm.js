Ок, забудь про це. працюємо з іншим кодом (попередньою версією pharm.js яку зараз скину), треба зробити можливість робити бекап та щоб за модальним вікном не було видно фон(прикріпив фото). з бодімав теж розібрались, будь дуже уважним до кодів та аналізу:
